...
NODE del_value(NODE head,int value);
int main()
{
int item,pos;
int i=1,value,ch;
...
printf("1.inser_front\t2.insert_end\t3.insert_pos\t4.Delete_front\t5.Del_end\t6.Del_value\t7.Display\n");
scanf("%d",&ch);
switch(ch)
{
case 1:
...
{printf("Value found at first pos\n");
